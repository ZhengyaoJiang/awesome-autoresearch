...
- **Flappy Bird game-playing AI** - Weco's autoresearch evolved a Flappy Bird agent from scratch over 100 iterations, improving mean score 2.76 → 20.9 (6.6×) for ~$12, with a public progress chart and an interactive search-tree trace. ([blog](https://weco.ai/blog/flappy-bird-case-study), [search tree](https://weco.ai/demo/flappy-bird-search-tree.html))
